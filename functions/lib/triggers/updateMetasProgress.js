 ...
 */
exports.onEstudoWrite = functions
        ...
        for (const metaDoc of metasValidas) {
            ...
            switch (meta.tipo) {
                case 'horas': {
                    ...
                    valorAtual = estudosFiltrados.reduce((acc, e) => acc + (e.tempoMinutos || 0), 0) / 60;
 ...
 */
exports.onSimuladoWrite = functions
    .region("southamerica-east1")
 ...
 */
exports.onConteudoProgressoWrite = functions
    .region("southamerica-east1")
...
//# sourceMappingURL=updateMetasProgress.js.map