...
exports.deleteTopico = exports.updateTopico = exports.createTopico = void 0;
/**
 ...
 */
async function verificarMentor(uid) {
...
exports.createTopico = functions
    ...
    try {
        ...
        if (!INCIDENCE_MAP[incidenceLevel]) {
            throw new functions.https.HttpsError("invalid-argument", "Nivel de incidencia invalido");
        }
        ...
        throw new functions.https.HttpsError("internal", `Erro ao criar topico: ${error.message}`);
    }
});
/**
...
exports.updateTopico = functions
    ...
    try {
        ...
        throw new functions.https.HttpsError("internal", `Erro ao atualizar topico: ${error.message}`);
    }
});
/**
...
exports.deleteTopico = functions
    ...
    try {
        ...
        throw new functions.https.HttpsError("internal", `Erro ao deletar topico: ${error.message}`);
    }
});
//# sourceMappingURL=topicos-crud.js.map